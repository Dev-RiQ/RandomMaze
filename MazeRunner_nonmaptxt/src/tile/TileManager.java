...
public class TileManager {
	...
	public void loadMap(String filePath) {
		try {
			InputStream is = new ByteArrayInputStream(filePath.getBytes()); // is에 txt 대치
